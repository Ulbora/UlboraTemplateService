...
func TestUpdateClearTemplate(t *testing.T) {
	var a []interface{}
	a = append(a, false, insertID, 126)
	//can also be: a := []interface{}{"test insert", time.Now(), "some content text", 125}
	success := dbConfig.UpdateClearTemplate(a...)
	if success != true {
		fmt.Println("database update failed")
		t.Fail()
	}
...
func TestDeleteTemplate(t *testing.T) {
	var a []interface{}
	a = append(a, insertID, 126)
	//can also be: a := []interface{}{"test insert", time.Now(), "some content text", 125}
	success := dbConfig.DeleteTemplate(a...)
	if success == true {
	...
	var a2 []interface{}
	a2 = append(a2, insertID2, 126)
	//can also be: a := []interface{}{"test insert", time.Now(), "some content text", 125}
	success2 := dbConfig.DeleteTemplate(a2...)
	if success2 == true {
		fmt.Print("deleted Id: ")
